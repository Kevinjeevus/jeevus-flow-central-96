...
export function EstimateForm({ onClose }: EstimateFormProps) {
  ...
  const handleSave = () => {
    toast({
      ...
      description: "Estimate has been saved as draft",
    });
    onClose();
  };
  ...
  const handleSend = () => {
    toast({
      title: "Estimate Sent",
      description: "Estimate has been sent to customer",
    });
    onClose();
  };
    ...
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Create a new estimate/quotation</p>
        </div>
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <Input
                id="customerEmail"
                type="email"
                value={estimateData.customerEmail}
            ...
            <div>
              ...
              <Input
                id="customerPhone"
                value={estimateData.customerPhone}
